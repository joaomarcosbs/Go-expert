...
// interfaces só aceitam implementação de métodos, não pode haver propriedades
// para implementar interfaces só precisa que as structs tenham o mesmo método que a interface, a implementação é automática
